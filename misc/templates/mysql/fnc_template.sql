-- ---------------------------------------------------------------------------------------------- --
-- Copyright 2011 : S.A.R.L. Acte 2i <informatique@acte2i.com>
-- contributeur : G. Qyy <pub-gh@qyy.fr>
-- contributeur : Juliette Fievet <juliette.fievet05@gmail.com>
-- 
-- Ce logiciel est un programme informatique servant à tester une nouvelles façon de concevoir les
-- bases de données MySQL. Ce logiciel est juste une "preuve de concept" et ne doit pas être
...
-- principes de diffusion des logiciels libres. Vous pouvez utiliser, modifier et/ou redistribuer
-- ce programme sous les conditions de la licence CeCILL-B telle que diffusée par le CEA, le CNRS
...
-- leurs systèmes et ou de leurs données et, plus généralement, à l'utiliser et l'exploiter dans
